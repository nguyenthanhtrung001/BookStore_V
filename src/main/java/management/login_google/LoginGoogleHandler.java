...
public class LoginGoogleHandler extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        UserGoogleDto user = UserGoogleDtoFactory.createUserGoogleDtoFromJson(getUserInfoJson(accessToken));
    ...
    public static String getUserInfoJson(final String accessToken) throws ClientProtocolException, IOException {
